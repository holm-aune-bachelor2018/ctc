...
def deep_lstm(units, input_dim=26, output_dim=29, dropout=0.2):
    ...
    # 3 LSTM layers
    x = CuDNNLSTM(units, kernel_initializer=kernel_init_rnn, bias_initializer=bias_init_rnn, unit_forget_bias=True, return_sequences=True, name='CuDNN_lstm1')(x)
    x = CuDNNLSTM(units, kernel_initializer=kernel_init_rnn, bias_initializer=bias_init_rnn, unit_forget_bias=True, return_sequences=True, name='CuDNN_lstm2')(x)
    x = CuDNNLSTM(units, kernel_initializer=kernel_init_rnn, bias_initializer=bias_init_rnn, unit_forget_bias=True, return_sequences=True, name='CuDNN_lstm3')(x)
